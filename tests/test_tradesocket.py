...
try:
    ...
    raise ImportError("These tests require the 'eventlet' library to run.  Available via 'pip install eventlet'.")


import tradesocket, os, atexit, sys, unittest
...
class BasicTest(unittest.TestCase):
    def runTest(self):
        ...
        assert sock.getsockname() == ('0.0.0.0', 5000)
        sock = baron.create_socket(('0.0.0.0', 5001))
        assert sock.getsockname() == ('0.0.0.0', 5001)
        baron.exit()